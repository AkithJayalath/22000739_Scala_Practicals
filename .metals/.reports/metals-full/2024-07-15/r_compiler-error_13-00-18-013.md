...
action parameters:
uri: file:///D:/UCSC/Year%202/Semester%201/Functional%20Programming/Scala_practicals/practical5/src/main/scala/q1.scala
text:
```scala
...
scala.runtime.Scala3RunTime$.assertFailed(Scala3RunTime.scala:11)
	...
	scala.meta.internal.pc.ScalaPresentationCompiler.semanticdbTextDocument$$anonfun$1(ScalaPresentationCompiler.scala:231)
```
#### Short summary: 
